...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public static class User32
    {
        ...
        public static extern bool SetWindowPos(IntPtr hWnd, IntPtr hwndAfter, int x, int y, int width, int height,
            int flags);
        ...
        public static extern bool EnumDisplayMonitors(IntPtr hdc, IntPtr lprcClip,
            Delegates.MonitorEnumDelegate lpfnEnum, IntPtr dwData);
        ...
        [DllImport("User32.dll", SetLastError = true)]
        public static extern bool InitializeTouchInjection(uint maxCount = 256,
            InjectedInputVisualizationMode feedbackMode = InjectedInputVisualizationMode.DEFAULT);

        [DllImport("User32.dll", SetLastError = true)]
        public static extern bool InjectTouchInput(int count, [MarshalAs(UnmanagedType.LPArray)] [In]
